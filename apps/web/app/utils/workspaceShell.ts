...
export const sidePanelCopy: Record<SidePanelKey, { title: string; desc: string }> = {
  ...
  objects: { title: "Draw", desc: "Draw on the canvas, then manage selected objects in one place." },
  generate: { title: "Generate", desc: "Generate project systems from the current site and drawing." },
  ...
  analysis: { title: "Review", desc: "See the issues that need attention and open Project Health for deeper evidence." },
