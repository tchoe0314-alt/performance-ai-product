...
export function buildPreviewInteractionState({
  ...
  return {
    ...
    allowEdits,
    showQuickDrawPalette: previewMode === "2d" && (allowEdits || drawMode !== "select") && drawMode !== "pan",
    showMobileDrawToolbar: previewMode === "2d" && (allowEdits || drawMode !== "select") && drawMode !== "pan",
    activeDrawMode,
