...
import { AlertTriangle, Droplets, Flame, GitBranch, Hand, MapPin, MousePointer2, Navigation, Pentagon, PencilLine, RotateCcw, Route, ShieldCheck, Square, Table2, X, ZoomIn, ZoomOut } from "lucide-react";
