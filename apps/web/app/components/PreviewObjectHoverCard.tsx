...
export function PreviewObjectHoverCard({ details }: PreviewObjectHoverCardProps) {
  ...
  return (
    <div className="pointer-events-none absolute left-1/2 top-full z-10 mt-3 w-48 -translate-x-1/2 rounded-2xl border border-slate-200 bg-white p-3 text-[11px] text-slate-600 shadow">
