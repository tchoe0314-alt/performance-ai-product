...
def _preview_engineering_profile(plan):
    ...
    release_blockers = _preview_release_truth_blockers(plan, meta, release_review if isinstance(release_review, dict) else {})
...
def _preview_merged_release_deliverables(*values: Any) -> List[str]:
    merged: List[str] = []
    for value in values:
...
def _preview_release_truth_blockers(plan: Dict[str, Any], meta: Dict[str, Any], release_review: Dict[str, Any]) -> List[str]:
    ...
    requested_deliverables = _preview_merged_release_deliverables(
        deliverables.get("requested"),
        release_review.get("requested_deliverables"),
    )
    produced_deliverables = _preview_merged_release_deliverables(
        deliverables.get("produced"),
        release_review.get("produced_deliverables"),
    )
    failed_deliverables = _preview_merged_release_deliverables(
        deliverables.get("failed"),
        release_review.get("failed_deliverables"),
    )
    missing_deliverables = _preview_merged_release_deliverables(
...
def _build_water_fire_flow_annotations(meta: Dict[str, Any]) -> Dict[str, Any]:
        ...
        pressure_zones.append(
            {
                ...
                "source_pressure_source": safe_text(rec.get("source_pressure_source") or pressure.get("source_pressure_source"), ""),
        ...
        scenario_runs.append(
            {
                ...
                "source_pressure_source": safe_text(fire.get("source_pressure_source") or pressure.get("source_pressure_source"), ""),
                "residual_pressure_source": safe_text(fire.get("residual_pressure_source") or pressure.get("residual_pressure_source"), ""),
                "fire_flow_criteria_source": safe_text(fire.get("fire_flow_criteria_source"), ""),
                "hydrant_evidence_source": safe_text(fire.get("hydrant_evidence_source"), ""),
                "utility_owner": safe_text(fire.get("utility_owner") or pressure.get("utility_owner"), ""),
                "utility_owner_criteria": safe_text(fire.get("utility_owner_criteria") or pressure.get("utility_owner_criteria"), ""),
    ...
    return {
        ...
        "readiness": {
            ...
            "water_fire_flow_proof": safe_dict(water.get("water_fire_flow_proof")),
