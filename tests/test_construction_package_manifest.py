...
class ConstructionPackageManifestTests(unittest.TestCase):
    ...
    def test_review_package_manifest_allows_alpha_review_without_construction_release(self) -> None:
        ...
        self.assertIn("source_artifacts", formats["civil3d"]["required_external_record"])
        self.assertIn("artifact_hashes", formats["civil3d"]["required_external_record"])
        self.assertIn("workflow_steps", formats["civil3d"]["required_external_record"])
        self.assertIn("preserved_elements", formats["civil3d"]["required_external_record"])
        self.assertIn("lost_limited_elements", formats["civil3d"]["required_external_record"])
        self.assertIn("screenshots_evidence_uri", formats["civil3d"]["required_external_record"])
        self.assertIn("review_only_status", formats["civil3d"]["required_external_record"])
