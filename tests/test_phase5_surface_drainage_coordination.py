...
class Phase5SurfaceDrainageCoordinationTests(unittest.TestCase):
    ...
    def test_drainage_export_validation_accepts_engineered_detention_candidates_without_exportable_flag(self) -> None:
        project = planner.ProjectModel(name="Unflagged Engineered Detention Candidate")
        project.meta["grading_summary"] = {
            "success": True,
            "fallback_used": False,
            "existing_surface": {"nrows": 5, "ncols": 5},
