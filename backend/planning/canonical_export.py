            ...
            canonical_action(
                {
                    ...
                    "meta": {
                        **_preview_meta(system="drainage", preview_role=PREVIEW_ROLE_FINAL),
                        ...
                        "elevation_ft": safe_float(z, 0.0) if z is not None else None,
                    },
                },
            ...
            canonical_action(
                {
                    ...
                    "meta": {
                        **_preview_meta(system="drainage", preview_role=PREVIEW_ROLE_FINAL),
                        "diameter_in": safe_float(diameter, 0.0) if diameter is not None else None,
                        "slope_ft_ft": safe_float(slope, 0.0) if slope is not None else None,
                        "invert_start_ft": safe_float(start_invert, 0.0) if start_invert is not None else None,
                        "invert_end_ft": safe_float(end_invert, 0.0) if end_invert is not None else None,
                    },
                },
            ...
            canonical_action(
                {
                    ...
                    "end_angle": None,
                    "meta": {
                        **_preview_meta(system="sanitary", preview_role=PREVIEW_ROLE_FINAL),
                        "diameter_in": safe_float(rec.get("diameter_in"), 0.0) if rec.get("diameter_in") is not None else None,
                        "slope_ft_ft": safe_float(rec.get("slope_ft_ft"), 0.0) if rec.get("slope_ft_ft") is not None else None,
                        "invert_start_ft": safe_float(rec.get("start_invert_ft"), 0.0) if rec.get("start_invert_ft") is not None else None,
                        "invert_end_ft": safe_float(rec.get("end_invert_ft"), 0.0) if rec.get("end_invert_ft") is not None else None,
                    },
                },
            ...
            canonical_action(
                {
                    ...
                    "end_angle": None,
                    "meta": {
                        **_preview_meta(system=system, preview_role=PREVIEW_ROLE_FINAL),
                        "diameter_in": safe_float(diameter, 0.0) if diameter is not None else None,
                        "slope_ft_ft": safe_float(slope, 0.0) if slope is not None else None,
                        "invert_start_ft": safe_float(rec.get("start_invert_ft"), 0.0) if rec.get("start_invert_ft") is not None else None,
                        "invert_end_ft": safe_float(rec.get("end_invert_ft"), 0.0) if rec.get("end_invert_ft") is not None else None,
