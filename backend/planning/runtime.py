...
_COORDINATION_KEYS = {
    ...
    "sanitary_storm_conflict_count",
    "unresolved_conflict_count",
    "resolved_conflict_count",
    "utility_related_unresolved_conflict_count",
    "utility_related_resolved_conflict_count",
    "utility_related_conflict_types",
    "selected_group_strategy_counts",
    "selected_candidate_mode_counts",
...
_DISCIPLINE_KEYS = {
    "grading": {
        ...
        "proposed_surface",
        "earthwork",
        "grading_source_quality",
        "grading_source_detail",
        "source_quality",
        "source_detail",
        "high_points",
        "checks",
    ...
    "storm_pipes": {
        ...
        "target_outfall",
        "target_outfall_name",
        "outfall_target_metadata",
        "hydraulic_summary",
        "hgl_profile",
        "egl_profile",
        "tailwater_elev_ft",
        "tailwater_source",
        "inlet_capacity_checks",
