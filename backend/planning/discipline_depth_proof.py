...
DISCIPLINE_PROOF_REQUIREMENTS: Dict[str, List[Dict[str, Any]]] = {
    ...
    "water": [
        {"id": "hydrants", "label": "Hydrants", "evidence": ("hydrant spacing evidence",), "blocker_terms": ("hydrant",)},
        {"id": "source_pressure", "label": "Source pressure", "evidence": ("pressure validation",), "blocker_terms": ("source pressure", "pressure")},
        {"id": "residual_pressure", "label": "Residual pressure", "evidence": ("fire flow validation", "pressure validation"), "blocker_terms": ("residual", "fire-flow", "fire flow")},
        {"id": "demand", "label": "Demand", "evidence": ("fire flow validation", "velocity checks"), "blocker_terms": ("demand", "flow")},
