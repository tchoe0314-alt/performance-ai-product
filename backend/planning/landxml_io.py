...
def build_landxml_pipe_network(plan: Dict[str, Any], *, network_name: str = "Civora Pipe Network") -> str:
    ...
    meta_node = ET.SubElement(
        ...
        "CivoraExportPackageReport",
        {
            ...
            "engineer_review_required": str(bool(report.get("engineer_review_required"))).lower(),
            "civora_signoff_allowed": str(bool(report.get("civora_signoff_allowed"))).lower(),
            "construction_release_allowed": str(bool(report.get("construction_release_allowed"))).lower(),
